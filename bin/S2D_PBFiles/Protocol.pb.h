...
/* @@protoc_insertion_point(class_definition:Protocol.HelloRequest) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "Protocol.HelloRequest"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:Protocol.HelloRequest)
 private:
  class _Internal;
...
/* @@protoc_insertion_point(class_definition:Protocol.HelloReply) */ {
 public:
 ...
 private:
  ...
  friend ::absl::string_view(
      ::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "Protocol.HelloReply"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:Protocol.HelloReply)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
...
inline const std::string& HelloRequest::name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:Protocol.HelloRequest.name)
...
inline PROTOBUF_ALWAYS_INLINE void HelloRequest::set_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:Protocol.HelloRequest.name)
}
inline std::string* HelloRequest::mutable_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:Protocol.HelloRequest.name)
  return _s;
}
...
inline std::string* HelloRequest::release_name() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:Protocol.HelloRequest.name)
...
inline void HelloRequest::set_allocated_name(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Protocol.HelloRequest.name)
}
...
inline const std::string& HelloReply::message() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:Protocol.HelloReply.message)
...
inline PROTOBUF_ALWAYS_INLINE void HelloReply::set_message(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:Protocol.HelloReply.message)
}
inline std::string* HelloReply::mutable_message() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:Protocol.HelloReply.message)
  return _s;
}
...
inline std::string* HelloReply::release_message() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:Protocol.HelloReply.message)
...
inline void HelloReply::set_allocated_message(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Protocol.HelloReply.message)
}
